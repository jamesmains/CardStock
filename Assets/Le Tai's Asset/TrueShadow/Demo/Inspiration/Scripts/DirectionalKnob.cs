...
public class DirectionalKnob : UIBehaviour, IDragHandler {
    ...
    public KnobValueChangedEvent knobValueChangedOverride;
    ...
    public void SetValueWithoutNotify(float newValue) {
        ...
        knobValueChangedOverride.Invoke(value); // I know this kinda goes against the "WithoutNotify" but shut up
    }
